  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {/* Question 1: Style */}
          <div className="koda-question" style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            <label style={{ fontSize: '1.125rem', fontWeight: 600, color: '#030213' }}>
              1. What's your design style? <span className="koda-optional" style={{ color: '#717182', fontWeight: 400 }}>(select one or more)</span>
            </label>
            <div className="koda-button-group" style={{ display: 'flex', flexWrap: 'wrap', gap: '0.75rem' }}>
          ...
          <div className="koda-question" style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            <label style={{ fontSize: '1.125rem', fontWeight: 600, color: '#030213' }}>
              3. Are there specific colors you want in the design? <span className="koda-optional" style={{ color: '#717182', fontWeight: 400 }}>(optional)</span>
            </label>
            <input
              type="text"
              value={colors}
          ...
          <div className="koda-question" style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            <label style={{ fontSize: '1.125rem', fontWeight: 600, color: '#030213' }}>
              4. Do you have icons or elements you want in the design? <span className="koda-optional" style={{ color: '#717182', fontWeight: 400 }}>(optional)</span>
            </label>
            <input
              type="text"
              value={elements}
          ...
          {/* Generate Button */}
          <div className="koda-button-container" style={{ paddingTop: '1.5rem', textAlign: 'center' }}>
            <button 
              onClick={generatePrompt} 
              className="koda-generate-button"
              style={{
                padding: '1rem 3rem',
                fontSize: '1.125rem',
                fontWeight: 600,
      ...
      {/* Footer */}
      <div className="koda-footer" style={{ textAlign: 'center', marginTop: '2rem' }}>
        <p style={{ color: '#717182', fontSize: '0.875rem', margin: 0 }}>
          Powered by <span className="koda-brand" style={{ fontWeight: 600, color: '#007a62' }}>Kocreators</span> • Custom merchandise printing solutions
        </p>
      </div>
    </div>
  );
